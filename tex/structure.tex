...
%\definecolor{myblue}{RGB}{0,102,204} % Define the blue color used for highlighting throughout the book
\definecolor{myblue}{RGB}{45,74,110} % Define the blue color used for highlighting throughout the book
...
%\fancyhead[RO,LE]{} \clearpage{\pagestyle{empty}\cleardoublepage}
\renewcommand{\headrulewidth}{0.25pt} % Width of the rule under the header
\addtolength{\headheight}{8.5pt} % Increase the spacing around the header slightly
...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= myblue,bookmarks=true,bookmarksopen=false,pdftitle={Title},pdfauthor={Author}}
\usepackage{bookmark}
\bookmarksetup{
open,
numbered,
