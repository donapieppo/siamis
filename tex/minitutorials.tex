...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/bardsleyj@mso.umt.edu}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/gabriele.facciolo@cmla.ens-cachan.fr}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/otmar.scherzer@univie.ac.at}.jpg}
\end{wrapfloat}
...
Inverse Problems is an interdisciplinary research
