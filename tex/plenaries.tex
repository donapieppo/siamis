...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/francis.bach@ens.fr}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/rchan@math.cuhk.edu.hk}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/yonina@ee.technion.ac.il}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/c.mandridake@surys.com}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/michalak@carnegiescience.edu}.jpg}
\end{wrapfloat}
...
\begin{wrapfloat}{figure}{o}{0pt}
  \includegraphics[width=0.33\textwidth]{{images/speakers/schnoerr@math.uni-heidelberg.de}.jpg}
\end{wrapfloat}
