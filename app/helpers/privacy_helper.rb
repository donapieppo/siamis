  ...
  def privacy_alert
    ...
    if cookies[name] 
      ...
      <div class="alert alert-warning alert-dismissible" role="alert">
         ...
         <span aria-hidden="true">&times; close</span></button> #{PRIVACY_TEXT}
      </div>|
    end
  end
end
...
PRIVACY_TEXT=%q|
<p>A number of our pages use <strong>cookies</strong> to identify you when you sign-in to our site.
