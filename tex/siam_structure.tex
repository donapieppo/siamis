...
\newcommand{\siamuserslistitem}[2]{\item {\textbf{#1}}: {#2}}

\newenvironment{siam_organizers}[1]{\smallskip\begin{itemize}[leftmargin=6mm]\item[]{\textbf{#1}:}}{\end{itemize}\smallskip}
\newenvironment{siam_speakers}{\smallskip\begin{itemize}[leftmargin=6mm]}{\end{itemize}\smallskip}
