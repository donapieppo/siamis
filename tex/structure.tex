...
\usepackage[top=1.7cm,bottom=1.7cm,left=2.4cm,right=1.7cm,headsep=10pt,a4paper]{geometry} % Page margins
...
\addtolength{\headheight}{8.5pt} % Increase the spacing around the header slightly % PIETRO, era 2.5
...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\ifusechapterimage\includegraphics[width=\paperwidth]{\thechapterimage}\fi};
\draw[anchor=west] (\Gm@lmargin,-9.5cm) node [line width=2pt,rounded corners=15pt,draw=ocre,fill=white,fill opacity=0.5,inner sep=15pt]{\strut\makebox[22cm]{}};
