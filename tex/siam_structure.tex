...
\newcommand{\panelitem}[4]{\begin{tabular}{ p{3cm} p{13cm} } \hfill\textbf{#1}\par\hfill\textbf{#2} & {\textbf{\color{siamblue}{\uppercase{#3}}}} \newline {#4} \end{tabular} \bigskip}

\newcommand{\gisection}[1]{\begin{gisectionbox}\section*{\normalsize{#1}}\end{gisectionbox}}

  \newenvironment{siampanelspeakers}{\begin{center}\begin{multicols}{2}}{\end{multicols}\end{center}}
\newcommand{\siampanelspeaker}[2]{\bigskip{\large\textbf{#1}}\\{#2}}
\newcommand{\siampanelimage}[1]{
  \begin{center}
    \includegraphics[width=0.3\textwidth]{#1}
  \end{center}
}

% \newenvironment{siamplenayspeakers}{\begin{multicols*}{2}}{\end{multicols*}}
\newcommand{\siamplenarydate}[1]{\vspace*{0.5cm}{\Large\noindent\textbf{#1}}}
\newcommand{\siamplenarytitle}[2]{\bigskip\begin{siamplenarytitlebox}{\begin{flushleft}\phantomsection\label{#1}\LARGE\textbf{{#1} {#2}}\end{flushleft}}\end{siamplenarytitlebox}}
\newcommand{\siamplenaryorganizer}[1]{\noindent \textbf{Chair: }{#1}}
\newcommand{\siamplenaryspeaker}[2]{\bigskip\noindent{\large\textbf{#1}}\\{#2}}
...
%\newenvironment{siam_schedule_sessions}{}{}
% \newenvironment{siam_schedule_session}{\par\noindent\rule{\textwidth}{0.4pt}\begin{multicols}{2}}{\end{multicols}}
...
\newcommand{\siamplenarysessiontitle}[2]      {\phantomsection\label{#1}\begin{siamplenarybox}      \textinbox{{#1} {#2}}\end{siamplenarybox}}
\newcommand{\siamminisymposiumsessiontitle}[2]{\phantomsection\label{#1}\begin{siamminisymposiumbox}\textinbox{{#1} {#2}}\end{siamminisymposiumbox}}
\newcommand{\siamsessiontitle}[2]             {\phantomsection\label{#1}\begin{siamsessionbox}      \textinbox{{#1} {#2}}\end{siamsessionbox}}
...
\newenvironment{siamuserslist}[1]{\begin{siamsessionbox} {\LARGE{\textbf{#1}}}\end{siamsessionbox} \bigskip\begin{description}}{\end{description}}
...
\newenvironment{siam_session_parts}{}{}
\newenvironment{siam_session_part}{\smallskip \begin{multicols}{2}}{\end{multicols}}
...
\newcommand{\siamprogramglanceday}[1]{\begin{center}\Large\textbf{\color{siamblue}{#1}}\end{center}\smallskip}
\newcommand{\siamprogramglanceitem}[4]{\item[{#1}] {#3} - {#2} {\small\textit{({#4})}} \hfill p.\pageref{#1}}

\newcommand{\siamabstractsessiontitle}[2]{\newpage\rhead{\textbf{#1}}\begin{siamsessionbox}\noindent{\phantomsection\label{#1}\large{\textbf{{#1} {#2}}}}\end{siamsessionbox}}
\newcommand{\siamabstractschedule}[3]{{\phantomsection\label{#1}\noindent\colorbox{siamblue}{\large{\color{white}\textbf{#1}}}}{ - \textbf{#2} \hfill {#3}\medskip}}
